    ...
    <div className="grid grid-cols-3 md:grid-cols-9 h-screen w-screen overflow-hidden">
      ...
      <div className="flex flex-col items-center flex-grow w-full md:ml-4 col-span-3 md:col-span-7">
        ...
        <section className="flex my-auto">
          ...
          {!loading && <PersonSlider persons={persons} userId={id} />}
          <Link
            to="/inbox"
            className="block md:hidden absolute shadow-3xl inset-0 top-auto font-bold text-white flex items-center justify-center uppercase p-4 h-12 bg-gradient-to-r from-pink-600 via-pink-600 to-yellow-500"
          >
            Inbox
          </Link>
        </section>
